export const applicationSections = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'marital_status', type: 'select', label: 'Marital Status', labelBm: 'Status Perkahwinan', help: 'This information is collected to help us understand personal commitments that may influence a candidate’s availability, scheduling flexibility, and ability to consistently participate in training and modelling opportunities. Nexa recognises that individual circumstances vary, and marital status alone will not determine a candidate’s suitability or performance.', helpBm: 'Maklumat ini dikumpulkan untuk membantu kami memahami komitmen peribadi yang mungkin mempengaruhi ketersediaan calon, fleksibiliti penjadualan dan keupayaan untuk menyertai latihan serta peluang modelling secara konsisten. Nexa mengakui bahawa keadaan setiap individu berbeza, dan status perkahwinan sahaja tidak akan menentukan kesesuaian atau prestasi calon.', options: ['Single', 'In a relationship', "It's complicated", 'Married', 'Divorced'], required: true },
